...
if sudo nala install cockpit cockpit-pcp -y; then
    ...
    echo "#                                                       #"
    echo -e "#  ${GREEN}Cockpit is running at https://$(hostname -I | awk '{print $1}'):9090${RESET}    #"
    echo "#                                                       #"
    echo "#########################################################"
    echo ""
    echo ""
...
echo "####################################################"
echo "#                                                  #"
echo -e "#  ${RED}[SUCCESS] Haas Firewall installation complete.${RESET}  #"
echo "#                                                  #"
echo "####################################################"
echo ""
echo ""
...
echo "#####################################################"
echo "#                                                   #"
echo -e "#  ${RED}Save the following output for reference${RESET}      #"
echo "#                                                   #"
echo "#####################################################"
echo ""
echo ""
...
echo "#---------------------------------------------------------------------------------- #"
echo -e  "# ${RED}sudo nano${RESET} $CONFIG_FILE                                                  #"
echo "#---------------------------------------------------------------------------------- #"
echo -e  "#  ${CYAN}set HAAS_MACHINES_SUBNET_V4="" to your CNC machines' IPv4 subnet${RESET}                   #"
echo "#-----------------------------------------------------------------------------------#"
echo -e  "#  ${CYAN}set HAAS_MACHINES_SUBNET_V6="" to your CNC machines' IPv6 subnet (if applicable)${RESET}   #"
echo "#---------------------------------------------------------------------------------- #"
echo "#####################################################################################"
echo ""
echo ""
