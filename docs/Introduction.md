...
2. Set Haas Options to output TCP/IP
      ...
      3. 263 - the `DPRNT Port` to use. Haas recommends using `TCP/IP` ports 5001 - 5099 to communicate with the server.
