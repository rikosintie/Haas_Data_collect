...
just shows the bare OS name (e.g. "Ubuntu 24.04 LTS") — with this same Tux
illustration as the background and "Haas CNC Data Collection Appliance" as
the title, so it's obvious at a glance which appliance you've logged into.
...
`docs/manage_the_appliance/img/tux_ops.resized.jpg` in the repo and
