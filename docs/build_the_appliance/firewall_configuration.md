...
!!! Note Enabling the firewall is optional
    The instructions will walk you through step by step, but if you make a mistake, you could lock yourself out unless you have a keyboard and monitor connected or purchased the [Serial cable](../build_the_appliance/build_an_appliance.md/#usb-serial-cable-for-the-raspberry-pi-5)
