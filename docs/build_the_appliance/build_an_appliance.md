...
See [Appendix A - Securing the Appliance](../appendices/appendix-a.md){: target="_blank" rel="noopener" } for details on the security used. [Red Hat Cockpit](https://www.redhat.com/en/blog/intro-cockpit){: target="_blank" rel="noopener" } is used to manage the appliance, so applying security updates and verifying firewall status is accomplished in a GUI.
...
[Appendix A - Securing the Appliance](../appendices/appendix-a.md){: target="_blank" rel="noopener" } and [Appendix B - Linux file permissions](../appendices/appendix-b.md){: target="_blank" rel="noopener" } go into detail on how the appliance operating system is secured. That should help with getting the request approved by IT and the security team.
...
If you are building the appliance for personal use, Ubuntu has a service that is free for up to five devices called `Ubuntu Pro`. Think of it as Microsoft support but for Ubuntu. The details are on the [Ubuntu Pro Pricing](https://ubuntu.com/pricing/pro){: target="_blank" rel="noopener" } page. For business use, the desktop version is $25/yr and the server version is $300/yr.
...
- [Revolution Pi](https://revolutionpi.com/en/products/revolution-pi-series){: target="_blank" rel="noopener" } - Revolution Pi is your open-source Linux platform for future-oriented industrial solutions:
    1. Powered by the Raspberry Pi Compute Module
    1. Raspberry Pi OS-based, industry-optimized operating system
- [Strato Pi](https://sferalabs.cc/strato-pi/){: target="_blank" rel="noopener" } - Industrial Raspberry Pi for Maximum Reliability
    1. Edge Computing
...
- [Adafruit](https://www.adafruit.com/){: target="_blank" rel="noopener" }
- [Waveshare](https://www.waveshare.com/){: target="_blank" rel="noopener" }
- [Ameridroid](https://ameridroid.com/){: target="_blank" rel="noopener" }

Sell a large array of add ons, cases, etc. for the Raspberry Pi 5.

Some examples:

- [Waveshare PoE Hat](https://www.waveshare.com/poe-hat-h.htm){: target="_blank" rel="noopener" } makes a $30 PoE hat that will power the RPI 5 from the Ethernet cable. Very convenient on the manufacturing floor.
- [Waveshare 4 port 2.5Gbps Ethernet](https://www.cnx-software.com/2025/12/30/add-four-gigabit-or-2-5gbps-ethernet-ports-to-the-raspberry-pi-5-with-this-expansion-board/){: target="_blank" rel="noopener" } - Support APs with 2.5 Gbps Ethernet.
- [Raspberry Pi AI Hat](https://www.adafruit.com/product/5979){: target="_blank" rel="noopener" } - No article is complete until AI is used! The AI HAT+ is available in 13 and 26 tera-operations per second (TOPS) variants, built around the Hailo-8L and Hailo-8 neural network inference accelerators.
- [Hi Resolution Camera](https://ameridroid.com/products/8mp-noir-raspberry-pi-camera-module){: target="_blank" rel="noopener" } - The Raspberry Pi Camera V2 is IR sensitive for low-light situations and features an upgraded 8MP Sony image sensor capable of taking 3280 x 2464 pixel images and capturing video at 1080p30, 720p60 and 640x480p90 resolutions. Like all Raspberry Pi camera modules, it works flawlessly with Raspberry Pi models using the latest Raspbian operating system.

### e-paper displays

 Waveshare makes great [e-paper displays](https://www.waveshare.com/product/displays/e-paper/3.97inch-e-paper-hat-plus.htm){: target="_blank" rel="noopener" } for the Pi. I built a serial console server using a Pi Zero W and a Waveshare display. On startup:
...
In the future I might add one to the Haas Data Collection appliance and display what machines are online. Here is the link to the Waveshare site: [3.97inch E-Paper Display](https://www.waveshare.com/product/displays/e-paper/epaper-2/3.97inch-e-paper-hat-plus.htm){: target="_blank" rel="noopener" }
...
- [Raspberry Pi 5 8GB - $104.48](https://www.amazon.com/dp/B0CK2FCG1K?ref=fed_asin_title){: target="_blank" rel="noopener" }
- [Waveshare case - $33.99](https://www.amazon.com/dp/B0D97VK1VW?ref=fed_asin_title){: target="_blank" rel="noopener" }
- [Waveshare PoE Hat - $28.49](https://www.amazon.com/dp/B0CR1JGP1Z?ref=fed_asin_title){: target="_blank" rel="noopener" }
- [RTC battery case - $5.49](https://www.amazon.com/dp/B0CRKQ2MG1?ref=fed_asin_title){: target="_blank" rel="noopener" }
- [Samsung 256GB NVME - $78.00](https://www.amazon.com/Samsung-SSD-PM9A1-NVMe-256GB/dp/B0BVKYN245){: target="_blank" rel="noopener" }

----------------------------------------------------------------

The Waveshare [case](https://www.amazon.com/dp/B0D97VK1VW?ref=fed_asin_title){: target="_blank" rel="noopener" } is industrial quality with ears to mount it to a back board. It has the following capabilities:
...
- ❤️ [Official Wiki Resources](https://www.amazon.com/stores/page/46D67D8E-DEF3-4032-A289-5C72C3DC78BE){: target="_blank" rel="noopener" }
...
!!! Note
    The case came with the wrong number of m2.5 x 6 flat head screws. I have never bought a Waveshare product that came with the wrong hardware. I had some from other projects but you should order some [mankk 360PCS Laptop Screws](https://www.amazon.com/mankk-Replacement-Computer-Motherboard-Screwdriver/dp/B0DRJPBLN7/142-6009986-5858014){: target="_blank" rel="noopener" } with the case.

    Also, the PoE hat came with 6mm x 16mm female/female standoffs. The case needs mal/female. I ordered these [YOKIVE 20 Pcs M2.5 Standoff Screws](https://www.amazon.com/YOKIVE-Standoff-Standoffs-Consistent-Motherboard/dp/B0BK98MP16){: target="_blank" rel="noopener" }.

----------------------------------------------------------------

## USB Serial cable for the Raspberry Pi 5

I recommend purchasing the [Waveshare Industrial USB to TTL (D) Serial Cable, compatible with the Raspberry Pi 5](https://www.amazon.com/Waveshare-Industrial-Compatible-Raspberry-Protection/dp/B0CX5C5KR4){: target="_blank" rel="noopener" } Serial to USB cable, for $13.99. The cable allows you to connect to the Raspberry Pi 5 if you lock yourself out over SSH. And that can happen when configuring the firewall. :smiley:
